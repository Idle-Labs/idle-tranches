...
contract IdleCDOStoragePolygon {
  ...
  // stkAave address
  address internal constant stkAave = address(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270);
  // aave address
  address internal constant AAVE = address(0xD6DF932A45C0f255f85145f286eA0b292B21C90B);
